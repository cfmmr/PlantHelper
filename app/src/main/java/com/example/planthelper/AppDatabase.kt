...
data class Planta(
    @PrimaryKey(autoGenerate = true) val ID_especie: Int,
    val Nome: String,
    val Tipo: String,
    val Toxicidade: String,
    val Fertelizacao: String,
    val Propagacao: String,
...
@Entity(tableName = "luminosidade")
data class Luminosidade(
    @PrimaryKey val ID_lumin: Int,
    val Luz_solar: String,
    val Densidade: String,
    val Ambiente: String,
    val Temp_min: Int,
    val Temp_max: Int
)
...
@Database(
    entities = [Planta::class, Luminosidade::class, Agua::class],
    version = 1,
    exportSchema = false
)
