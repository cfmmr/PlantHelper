...
class MainViewModel(private val db: AppDatabase) : ViewModel() {
    ...
    init { viewModelScope.launch { if (db.plantaDao().getAll().isEmpty()) { insert() }; loadPlanta() } }
    private suspend fun loadPlanta() { _plants.value = db.plantaDao().getAll() }
    fun insertPlanta(planta: Planta) { viewModelScope.launch { db.plantaDao().insert(planta); loadPlanta() } }
    fun updatePlanta(planta: Planta) { viewModelScope.launch { db.plantaDao().update(planta); loadPlanta() } }
    fun deletePlanta(planta: Planta) { viewModelScope.launch { db.plantaDao().delete(planta); loadPlanta() } }
    private suspend fun loadLuminosidade() { _luminosidades.value = db.luminosidadeDao().getAll() }
    fun insertLuminosidade(luminosidade: Luminosidade) { viewModelScope.launch { db.luminosidadeDao().insert(luminosidade); loadLuminosidade() } }
    fun updateLuminosidade(luminosidade: Luminosidade) { viewModelScope.launch { db.luminosidadeDao().update(luminosidade); loadLuminosidade() } }
    fun deleteLuminosidade(luminosidade: Luminosidade) { viewModelScope.launch { db.luminosidadeDao().delete(luminosidade); loadLuminosidade() } }
    private suspend fun loadAgua() { _aguas.value = db.aguaDao().getAll() }
    fun insertAgua(agua: Agua) { viewModelScope.launch { db.aguaDao().insert(agua); loadAgua() } }
    fun updateAgua(agua: Agua) { viewModelScope.launch { db.aguaDao().update(agua); loadAgua() } }
    fun deleteAgua(agua: Agua) { viewModelScope.launch { db.aguaDao().delete(agua); loadAgua() } }
    ...
    private fun insert() { viewModelScope.launch {
        val planta = listOf(
            ...
            Planta(3, "Aglaonema Zinkon", "Ornamental", "Sim", "Mensal", "Divisão da Raíz", "2"),
            Planta(4, "Asparagus Plumosus", "Arbusto", "Sim", "Mensal", "Divisão da Raíz", "2"),
            Planta(5, "Chamaedorea Elegans", "Ornamental", "Não", "Mensal", "Divisão da Raíz", "2"),
            Planta(6, "Calathea Makoyana", "Ornamental", "Não", "Quinzenal", "Divisão da Raíz", "3"),
            Planta(7, "Philodendron Wizard", "Ornamental", "Sim", "Semanal", "Corte do Caule", "1"),
            Planta(8, "Calathea Triostar", "Ornamental", "Não", "Quinzenal", "Divisão da Raíz", "3"),
            Planta(9, "Zamioculcas Raven", "Ornamental", "Sim", "Anual", "Divisão da Raíz", "1"),
            Planta(10, "Tradescantia Fluminesis", "Ornamental", "Sim", "Quinzenal", "Corte do Caule", "1"),
            Planta(11, "Dracaena Fragans", "Ornamental", "Sim", "Quinzenal", "Corte do Caule", "2"),
            Planta(12, "Epipremnum Aureum", "Ornamental", "Sim", "Mensal", "Corte do Caule", "1"),
            Planta(13, "Peperomia Prostata", "Suculenta", "Não", "ensal", "Corte da Folha", "1"),
            Planta(14, "Alocasia Cuprea", "Ornamental", "Sim", "Quinzenal", "Divisão da Raíz", "3"),
            Planta(15, "Monstera Adansonii", "Ornamental", "Sim", "Anual", "Corte do Caule", "2"),
            Planta(16, "Peperomia Caperata", "Suculenta", "Não", "Quinzenal", "Corte da Folha", "1"),
            ...
            Planta(19, "Begonia Maculata", "Ornamental", "Sim", "Quinzenal", "Corte da Folha", "4"),
            Planta(20, "Monstera Deliciosa", "Ornamental", "Sim", "Quinzenal", "Corte do Caule", "2"),
            Planta(21, "Caladium Bicolor", "Ornamental", "Sim", "Mensal", "Divisão da Raíz", "4"),
            Planta(22, "Alocasia x Amazonica", "Ornamental", "Sim", "Quinzenal", "Divisão da Raíz", "4"),
            Planta(23, "Dracaena Reflexa", "Ornamental", "Sim", "Quinzenal", "Corte do Caule", "2"),
            Planta(24, "Fittonia Albivenis", "Ornamental", "Não", "Mensal", "Corte da Folha", "3"),
            Planta(25, "Philodendron Cardinal", "Ornamental", "Sim", "Semanal", "Corte do Caule", "2"),
            Planta(26,"Philodendron Hederaceum", "Ornamental", "Não", "Semanal", "Corte do Caule", "2"),
            Planta(27, "Tradescantia Bubblegum", "Ornamental", "Sim", "Quinzenal", "Corte do Caule", "2"),
            Planta(28, "Syngonium Podophylum", "Ornamental", "Sim", "Anual", "Corte do Caule", "3"),
            Planta(29, "Senecio Rowleyanus", "Suculenta", "Sim", "Anual", "Corte do Caule", "3"),
            Planta(30, "Rosa x odorata", "Ornamental", "Não", "Quinzenal", "Corte do Caule", "4"),
            Planta(31, "Ceropegia Woddi", "Suculenta", "Não", "Quinzenal", "Corte do Caule", "2"),
            Planta(32, "Lavandula Augustifolia", "Ornamental", "Sim", "Anual", "Corte do Caule", "3"),
            Planta(33, "Ficus Pumila", "Feto", "Sim", "Mensal", "Corte da Folha", "3"),
            Planta(34, "Dryopteris Flix-mas", "Feto", "Sim", "Anual", "Divisão da Raíz", "3"),
            Planta(35,"Adiantum Capillus-Veneris", "Feto", "Sim", "Anual", "Divisão da Raíz",  "4")
        )
